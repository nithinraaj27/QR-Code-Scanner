...
class co6 extends StatefulWidget {
  @override
  _co6State createState() => _co6State();
}

class _co6State extends State<co6> {
                                  ...
                                  child: SingleChildScrollView(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Text(
                                          "It Allows capital letters,numbers and small letters with length of  16 characters",
  ...
  Future<Null> _capturePng() async {
    try {
      ...
      Share.shareFiles(
        ...
        text: 'Your Code128B Image,This app is Made by Nithinraaj J',
