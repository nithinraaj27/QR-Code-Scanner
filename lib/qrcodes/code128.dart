...
class co4 extends StatefulWidget {
  @override
  _co4State createState() => _co4State();
}

class _co4State extends State<co4> {
  ...
  Future<Null> _capturePng() async {
    try {
      ...
      Share.shareFiles(
        ...
        text: 'Your Code128 Image,This app is Made by Nithinraaj J',
