...
class co7 extends StatefulWidget {
  @override
  _co7State createState() => _co7State();
}

class _co7State extends State<co7> {
                                  ...
                                  child: SingleChildScrollView(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Text(
                                          "It Allows capital letters,numbers,symbles and special character with length of  16 characters",
  ...
  Future<Null> _capturePng() async {
    try {
      ...
      Share.shareFiles(
        ...
        text: 'Your Code128C Image,This app is Made by Nithinraaj J',
