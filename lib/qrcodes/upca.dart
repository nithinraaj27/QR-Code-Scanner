...
class co8 extends StatefulWidget {
  @override
  _co8State createState() => _co8State();
}

class _co8State extends State<co8> {
                                  ...
                                  child: SingleChildScrollView(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Text(
                                          "You must need to type 12 numbers to get code and It allows only 12 numbers",
  ...
  Future<Null> _capturePng() async {
    try {
      ...
      Share.shareFiles(
        ...
        text: 'Your Code UPCA Image,This app is Made by Nithinraaj J',
