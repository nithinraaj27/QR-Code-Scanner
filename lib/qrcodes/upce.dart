...
class co9 extends StatefulWidget {
  @override
  _co9State createState() => _co9State();
}

class _co9State extends State<co9> {
                                  ...
                                  child: SingleChildScrollView(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Text(
                                          "You must need to type 6 numbers to get code and It allows only 6 numbers",
  ...
  Future<Null> _capturePng() async {
    try {
      ...
      Share.shareFiles(
        ...
        text: 'Your UPC E Image,This app is Made by Nithinraaj J',
